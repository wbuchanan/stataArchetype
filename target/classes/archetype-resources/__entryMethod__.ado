...
*                                                                             *
* DESCRIPTION:                                                                *
*   Add information about what the ${entryMethod} command does.               *
*   Ex.                                                                       *
...
cap prog drop ${entryMethod}

// Define program
prog def ${entryMethod}
	...
	*/
    ...
    [namelist(name=${artifactId} if="What to display" local min=# max=#)]    ///
	[anything(name=${artifactId} id="What to display" equalok everything)]   ///
    [using/]                                                                 ///
    [=/exp]                                                                  ///
    [fw aw pw iw/]                                                           ///
    [if] [in] [,                                                             ///
