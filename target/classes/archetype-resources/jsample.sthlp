...
{marker jsample}{p 2 2 2}{title:JSAMPLE}{p_end}

{p 4 4 4}{hi:jsample {hline 2}} Describe your program here. {p_end}

{marker syntax}{p 2 2 2}{title:Syntax}{p_end}

{p 4 4 4}{cmd:jsample} [{varlist}] {ifin} , {cmdab:req:opt(}{it:argtype}{opt )}
[{cmdab:opt:ion(}{it:argtype}{opt )}] {p_end}

{marker opts}{p 2 2 2}{title:Options}{p_end}

{p 4 4 4}{cmdab:req:opt} is a required argument for ... {p_end}

{p 4 4 4}{cmdab:opt:ion} is an optional argument for ... {p_end}

{marker examples}{p 2 2 2}{title:Examples}{p_end}

{p 4 4 4}Text explaining the example that follows. {p_end}

{p 8 8 12}{stata command here}{p_end}
...
{p 12 12 12}{browse ${scm}/issues}{p_end}
