...
{cmd:help newMethodThatDoesStuffAndThings}
{hline}

{marker newMethodThatDoesStuffAndThings}{p 2 2 2}{title:newMethodThatDoesStuffAndThings}{p_end}

{p 4 4 4}{hi:newMethodThatDoesStuffAndThings {hline 2}} Describe your program here. {p_end}

{marker syntax}{p 2 2 2}{title:Syntax}{p_end}

{p 4 4 4}{cmd:newMethodThatDoesStuffAndThings} [{varlist}] [{it:namelist}] [{it:anything}]
...
{p 12 12 12}{browse https://github.com/wbuchanan/stataArchetype/issues}{p_end}
