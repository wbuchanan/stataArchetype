...
{cmd:help methodUsedByJavacallCommand}
{hline}

{marker methodUsedByJavacallCommand}{p 2 2 2}{title:methodUsedByJavacallCommand}{p_end}

{p 4 4 4}{hi:methodUsedByJavacallCommand {hline 2}} Describe your program here. {p_end}

{marker syntax}{p 2 2 2}{title:Syntax}{p_end}

{p 4 4 4}{cmd:methodUsedByJavacallCommand} [{varlist}] [{it:namelist}] [{it:anything}]
...
{p 8 8 12}{stata methodUsedByJavacallCommand:methodUsedByJavacallCommand}{p_end}
...
{p 12 12 12}{browse https://github.com/username/yourProject.git/issues}{p_end}

{marker author}{p 2 2 2}{title:Author}{p_end}
{p 4 4 4}Your Actual Name{p_end}
{p 4 4 4}Where you work{p_end}
